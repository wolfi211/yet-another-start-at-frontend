...
export const colorsBgLight = {
  ...
  info: 'bg-cyan-500 border-cyan-500 text-white',
}
...
export const colorsOutline = {
  ...
  info: [colorsText.info, 'border-cyan-500'],
}
...
export const getButtonColor = (
  ...
  const colors = {
    ring: {
      ...
      info: 'ring-cyan-300 dark:ring-cyan-700',
    },
    active: {
      white: 'bg-gray-100',
      whiteDark: 'bg-gray-100 dark:bg-slate-800',
      lightDark: 'bg-gray-200 dark:bg-slate-800',
    ...
    bg: {
      ...
      lightDark: 'bg-gray-100 text-black dark:bg-slate-700 dark:text-white',
      contrast: 'bg-gray-800 text-white dark:bg-white dark:text-black',
      success: 'bg-emerald-600 dark:bg-emerald-500 text-white',
      danger: 'bg-red-600 dark:bg-red-500 text-white',
      warning: 'bg-yellow-600 dark:bg-yellow-500 text-white',
      info: 'bg-cyan-400 dark:bg-cyan-500 text-white',
    },
    bgHover: {
      white: 'hover:bg-gray-100',
      whiteDark: 'hover:bg-gray-100 hover:dark:bg-slate-800',
      lightDark: 'hover:bg-gray-200 hover:dark:bg-slate-600',
      ...
      info: 'hover:bg-cyan-500 hover:border-cyan-500 hover:dark:bg-cyan-600 hover:dark:border-cyan-600',
    },
    borders: {
      white: 'border-white',
    ...
    outlineHover: {
      ...
      success:
        'hover:bg-emerald-600 hover:text-white hover:dark:text-white hover:dark:border-emerald-600',
      danger: 'hover:bg-red-600 hover:text-white hover:dark:text-white hover:dark:border-red-600',
      warning:
        'hover:bg-yellow-600 hover:text-white hover:dark:text-white hover:dark:border-yellow-600',
      info: 'hover:bg-cyan-600 hover:text-white hover:dark:text-white hover:dark:border-cyan-600',
    },
  }

  if (!colors.bg[color as keyof typeof colors.bg]) {
    return color
  }
  ...
  const base = [
    // colors.borders[color as keyof typeof colors.borders],
    colors.ring[color as keyof typeof colors.ring],
  ]

  if (isActive) {
    base.push(colors.active[color as keyof typeof colors.active])
  } else {
    base.push(
      isOutlinedProcessed
        ? colors.text[color as keyof typeof colors.text]
        : colors.bg[color as keyof typeof colors.bg],
    )
  }
  ...
  if (hasHover) {
    base.push(
      isOutlinedProcessed
        ? colors.outlineHover[color as keyof typeof colors.outlineHover]
        : colors.bgHover[color as keyof typeof colors.bgHover],
    )
  }
